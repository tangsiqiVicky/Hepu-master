<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/msite'})" class="guide_item">
          <p class="icon_style"><i class="fa fa-hand-paper-o" :class="$route.path.indexOf('msite') == 1? 'active' : ''"></i></p>
          <span :class="$route.path.indexOf('msite') == 1? 'active' : ''">商家</span>
        </section>
      <!--{path: '/food/' + geohash}-->
        <section @click = "gotoAddress({path: '/food'})" class="guide_item">

          <p class="icon_style"><i class="fa fa-th" :class="$route.path.indexOf('food') == 1? 'active' : ''"></i></p>
          <span :class="$route.path.indexOf('food') == 1? 'active' : ''">商品</span>
        ...
        <!--<section @click = "gotoAddress('/order')" class="guide_item" >-->
        	<!--&lt;!&ndash;<svg class="icon_style">&ndash;&gt;-->
                <!--&lt;!&ndash;<use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('order') !== -1? '#orderActive' : '#order'"></use>&ndash;&gt;-->
            <!--&lt;!&ndash;</svg>&ndash;&gt;-->
          <!--<p class="icon_style"><i class="fa fa-file-text" :class="$route.path.indexOf('order') == 1? 'active' : ''"></i></p>-->
          <!--<span  :class="$route.path.indexOf('order') == 1? 'active' : ''">购物车</span>-->
        <!--</section>-->
        <section @click = "gotoAddress('/profile')" class="guide_item" >
        	<!--<svg class="icon_style">-->
                <!--<use xmlns:xlink="http://www.w3.org/1999/xlink" ></use>-->
            <!--</svg>-->
          <p class="icon_style"><i class="fa fa-user-circle" :class="$route.path.indexOf('profile') == 1? 'active' : ''"></i></p>
