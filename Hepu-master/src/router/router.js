...
const registration = r => require.ensure([], () => r(require('../page/registration/registration')), 'registration')
...
const protocolDetail = r => require.ensure([], () => r(require('../page/shop/children/protocolDetail')), 'protocolDetail')
