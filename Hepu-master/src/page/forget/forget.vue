    ...
    <div class="restContainer">
        ...
        <form class="restForm">
            ...
            <section class="input_container captcha_code_container">
              <input class="input" type="text" placeholder="验证码" name="mobileCode" maxlength="6" v-model="mobileCode">
            </section>
             <!--<section class="input_container">-->
                <!--<input type="text" placeholder="旧密码" name="oldPassWord" v-model="oldPassWord">-->
            <!--</section>-->
            <section class="input_container">
                <input class="input"  type="password" placeholder="请输入新密码" name="newPassWord" v-model="newPassWord">
            </section>
            <section class="input_container">
                <input class="input"  type="password" placeholder="请确认密码" name="confirmPassWord" v-model="confirmPassWord">
            </section>
        </form>
        <div class="login_container" @click="resetButton">确认修改</div>
        <router-link to="/login" class="to_forget" >登录？</router-link>
        <router-link to="/registration" class="to_forget">注册？</router-link>
...
//                }
                ...
                // 发送重置信息
                let res = await changePassword(this.phoneNumber, this.mobileCode, this.newPassWord, this.confirmPassWord);
                 res = res.data[0]
                if (res.result === '0') {
                    this.showAlert = true;
