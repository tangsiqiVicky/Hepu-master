 <template>
    <div class="address_page">
        ...
        <section class="page_text_container">
            ...
            <section class="section_list">
                <span class="section_left">地址</span>
                <section class="section_right">
                    ...
                    <input type="text" name="address_detail" placeholder="详细地址" v-model="address_detail" class="input_style">
            ...
            <!--<section class="section_list">-->
              ...
              <!--<section class="section_right">-->
                <!--<input type="remark" name="remark" placeholder="备注" v-model="remark" class="input_style">-->
              <!--</section>-->
            <!--</section>-->
            <!--<section class="section_list">-->
...
//                    this.tag_type = 4;
//                }
                let res = await postAddAddress(this.userInfo.user_id, this.name,this.phone,this.address_detail,this.remark);
                //保存成功返沪上一页，否则弹出提示框
                res = res.data;
                if (res.result) {
                    this.showAlert = true;
