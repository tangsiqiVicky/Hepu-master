	...
	<div class="rating_page">
        ...
        <section class="shop_status_info">
          <!--{{shopDetail}}-->
            <header>商家信息</header>
            <p>{{shopDetail.name}}</p>
            <p>省市区：{{shopDetail.province}}{{shopDetail.city}}</p>
            <p>地址：{{shopDetail.address}}</p>
            <p>{{shopDetail.desc}}</p>

            <div v-for="(item,index) in imgUrl">
              <p><img class="shop_img" :src="imgBaseUrl+item.url" alt=""></p>
            </div>
...
//        [
//          {
//            url:'upload_folder/product/U-15604578366/2017-12-04/01_DLD3_wtkSuzLU1X0Yb1wcLJeEbf4mUzZkAiB84lKkLOeL3bVnFAWvcI9bGF_d7Fc.jpg'
//          },
//          {
//            url:'upload_folder/product/U-15604578366/2017-12-04/01_Vs4Upd1-Aq-EOy38JdvUeMqfCApEJ2ltSQsc4e15JUXMY-OpTzDLmtHVVjUiB6Dr.jpg'
//          },
//          {
//            url:'upload_folder/product/U-15604578366/2017-12-04/01_NWOjeo7vPlJPWcMXSa0H3_n4zOeRL6rcpitaWUB6X1Dx2jM8XczRu53pWa-PLd1b.jpg'
//          },
//          {
//            url:'upload_folder/product/U-15604578366/2017-12-04/01_Usm4jx0iog0JgzHhrKApt20E3ntLEVPczODfAc9GUKklxZJRR2s12g1-c9-QHTgg.jpg'
//          }
//        ]

        var slidesimgs = this.shopDetail.slidesimg.split(";");

        for (var i = 0; i < slidesimgs.length; i++) {
          if (slidesimgs[i] != "") {
            this.imgUrl.push({url: slidesimgs[i]});
          }

        }
        console.log('shopDetail',this.imgUrl);
      },
      showLicenseImg(img){
          this.licenseImg = img;
